...
const { DisconnectReason } = require('../Types/index.js');
const { getAllBinaryNodeChildren, jidDecode } = require('../WABinary/index.js');
...
const generateMessageID = () => 'XZCYYX-' + randomBytes(18).toString('hex').toUpperCase();
