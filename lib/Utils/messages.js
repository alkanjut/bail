...
const { CALL_AUDIO_PREFIX, CALL_VIDEO_PREFIX, MEDIA_KEYS, URL_REGEX, WA_DEFAULT_EPHEMERAL } = require('../Defaults/index.js');
const { WAMessageStatus, WAProto } = require('../Types/index.js');
const { isJidGroup, isJidNewsletter, isJidStatusBroadcast, jidNormalizedUser } = require('../WABinary/index.js');
const { sha256 } = require('./crypto.js');
const { generateMessageIDV2, getKeyAuthor, unixTimestampSeconds } = require('./generics.js');
const { downloadContentFromMessage, encryptedStream, generateThumbnail, getAudioDuration, getAudioWaveform, getRawMediaUploadData } = require('./messages-media.js');
const { shouldIncludeReportingToken } = require('./reporting-utils.js');
const MIMETYPE_MAP = {
    image: 'image/jpeg',
    video: 'video/mp4',
