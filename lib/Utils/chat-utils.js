...
const { expandAppStateKeys } = require('whatsapp-rust-bridge');
const { proto } = require('../../WAProto/index.js');
const { LabelAssociationType } = require('../Types/LabelAssociation.js');
const { getBinaryNodeChild, getBinaryNodeChildren, isJidGroup, jidNormalizedUser } = require('../WABinary/index.js');
const { aesDecrypt, aesEncrypt, hmacSign } = require('./crypto.js');
const { toNumber } = require('./generics.js');
const { LT_HASH_ANTI_TAMPERING } = require('./lt-hash.js');
const { downloadContentFromMessage } = require('./messages-media.js');
const { emitSyncActionResults, processContactAction } = require('./sync-action-utils.js');
...
exports.MAX_SYNC_ATTEMPTS = MAX_SYNC_ATTEMPTS;
/**
